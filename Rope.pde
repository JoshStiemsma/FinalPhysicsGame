class Rope {
  ...
  Rope(float l, int n, Vec2 pos) {
    ...
    for (int i=0; i < numPoints+1; i++) {
      ...
      if (i == 0 ) b = new Box(new Vec2(pos.x, pos.y-10), new Vec2(10, 10), true, 10);
      else b = new Box(new Vec2(pos.x, pos.y+(10*i)), new Vec2(5+(i*2), 5+(i*2)), false, 10);
      boxes.add(b);
